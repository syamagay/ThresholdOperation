...
class ReadDatFile {
 public:
  ...
  void set_parameter(std::string name1, int par1, std::string name2, int par2,std::string name3, int par3,std::string name4,double par4[400][192],std::string name5,double par5[400][192],std::string name6,double par6[400][192],std::string vianame1,double viapar1[400][192]);
 ...
 private:
  ...
  std::string via_parName1;
  std::vector <std::vector<int> > via_parameter1;
  ...
  std::vector < std::vector <std::vector<double> > > value_map;
  int vector_iterator;
