...
i_candidate=(2 12 14 16 17 24 25 27 28 32 44 47)
...
#    target_threshold=$target_threshold_start
    ...
    ./edit_thresholdscan.sh 0 $middle_max 5 $scan_json
    #echo "-------------------target threshold middle------------------------------"
    #echo $target_threshold_middle

    cd $YARR_DIR
    ./scripts/doScan.sh -a rd53a -m ${module_name} -s diff_tune_globalthreshold -t $target_threshold_middle >> ${output_dir}/gayaLog${i}.log 2>&1
    ./scripts/doScan.sh -a rd53a -m ${module_name} -s diff_tune_pixelthreshold -t $target_threshold_middle >> ${output_dir}/gayaLog${i}.log 2>&1
    ...
    cd $YARR_DIR
    ./scripts/doScan.sh -a rd53a -m ${module_name} -s diff_retune_globalthreshold -t $target_threshold >> ${output_dir}/gayaLog${i}.log 2>&1
    ./scripts/doScan.sh -a rd53a -m ${module_name} -s diff_retune_pixelthreshold -t $target_threshold >> ${output_dir}/gayaLog${i}.log 2>&1
